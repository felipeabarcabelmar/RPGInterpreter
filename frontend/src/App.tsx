...
import { Layout, MessageSquare, LogOut, Tag, Database } from 'lucide-react';
  ...
  if (authenticated === null) {
    return (
      <div className="h-screen w-full flex items-center justify-center bg-[#0d1117]">
        <div className="animate-pulse text-blue-500 font-medium tracking-tighter text-xl">RPG Interpreter...</div>
      </div>
    );
  }
